	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("Registro")!=null) {
			...
			if(usuarioDTO!=null) {
				...
				response.sendRedirect("Usuario.jsp?men=El usuario no esta registrado");
			}
		}
			...
			if(usuDAO.editarUsu(usuDTO)) {
				response.sendRedirect("Usuario.jsp?men=El usuario fue actualizado correctamente");
			}
			else {
				response.sendRedirect("Usuario.jsp?men=El usuario no fue actualizado");
			}
		}
			...
			if(usuDAO.eliminar(cedula)) {
				...
				response.sendRedirect("Usuario.jsp?men=El usuario no se elimino");
			}
		}
	}
