...
PrintWriter salida=response.getWriter();
		...
		if(request.getParameter("Registro") !=null) { 
			...
			if(clienteDTO==null) {
				...
				else { response.sendRedirect("Cliente.jsp?men=Error el usuario no se registro");
	}}
		}
				//BUSCAR
					...
					if(clienteDTO!=null) {
						...
						salida.print("el cliente no esta registrado");
				}
				...
				//ACTUALIZAR
					...
					if(cliDAO.editarCli(cliDTO)) {
						...
						salida.print("El cliente no fue actualizo");
					}
				}
				//ELIMINAR
					...
					if(cliDAO.eliminar(cedula)) {
						...
						salida.print("El cliente no se elimino");
